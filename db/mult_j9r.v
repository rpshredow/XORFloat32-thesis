//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="AUTO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=3 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=24 LPM_WIDTHB=13 LPM_WIDTHP=37 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [12:0]  datab_input_reg;
	reg  [36:0]  result_output_reg;
	reg  [36:0]  result_extra0_reg;
	wire [23:0]    dataa_wire;
	wire [12:0]    datab_wire;
	wire [36:0]    result_wire;
	...
	// synopsys translate_on
	always @(posedge clock)
		result_extra0_reg <= result_wire[36:0];
