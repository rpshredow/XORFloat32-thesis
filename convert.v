...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
module  convert_altbarrel_shift_kof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //convert_altbarrel_shift_kof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_altfp_convert_7qm
	( 
	clock,
	dataa,
	result) ;
	...
	convert_altbarrel_shift_kof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //convert_altfp_convert_7qm
//VALID FILE
...
module convert (
	...
	convert_altfp_convert_7qm	convert_altfp_convert_7qm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
