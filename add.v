...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab result
...
module  add_altbarrel_shift_ltd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //add_altbarrel_shift_ltd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altbarrel_shift_aeb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //add_altbarrel_shift_aeb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //add_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
...
endmodule //add_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	add_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
...
endmodule //add_altpriority_encoder_qb6
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
...
endmodule //add_altpriority_encoder_fj8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //add_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altpriority_encoder_e48
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	add_altpriority_encoder_fj8   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	add_altpriority_encoder_f48   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //add_altpriority_encoder_e48

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_altfp_add_sub_nti
	( 
	clock,
	dataa,
	datab,
	...
	add_altbarrel_shift_ltd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	add_altbarrel_shift_aeb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	add_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	add_altpriority_encoder_e48   trailing_zeros_cnt
	( 
...
endmodule //add_altfp_add_sub_nti
//VALID FILE
...
module add (
	...
	add_altfp_add_sub_nti	add_altfp_add_sub_nti_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
