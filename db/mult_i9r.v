//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="AUTO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=3 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=25 LPM_WIDTHB=25 LPM_WIDTHP=50 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [49:0]  result_output_reg;
	reg  [49:0]  result_extra0_reg;
	wire [24:0]    dataa_wire;
	wire [24:0]    datab_wire;
	wire [49:0]    result_wire;
	...
	// synopsys translate_on
	always @(posedge clock)
		result_extra0_reg <= result_wire[49:0];
